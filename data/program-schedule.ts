...
export const Day1: ScheduleData[] = [
  {
    head: [
      [
    ...
    columns: ["PRE TUTORIAL TRACK 01", "", " Processors & Communication Systems", "BT Seminar Hall"],
    rows: [
      [
        "9:30AM to 11:00AM",
        // "Mr. G Balaj, ABB",
      ...
      ["02.00PM to 03.15PM", "FGPAs for wireless Communications", "Hariprasad Bhat,Manager-FGPA Solutions, Leka Wireless & team", "BT Seminar Hall"],
      ["03.15PM to 03.30PM", "----", "High Tea", "----"],
      ["03.30PM to 04.30PM", "FGPAs for wireless Communications", "Hariprasad Bhat,Manager-FGPA Solutions, Leka Wireless & team", "BT Seminar Hall"],
    ],
  },
  {
    head: [
    ...
    columns: ["PRE TUTORIAL TRACK 2", "", "Computing Systems and Applications & Intelligent Systems Venue", "MCA Seminar Hall"],
    rows: [
      [
        "09:30AM to 11:00AM",
        // "Mr. G Balaj, ABB",
  ...
  },
  {
    ...
    columns: ["PRE TUTORIAL TRACK 3", "", "Sensors: Sensors, Automation & Process Control; Energy Systems", "IEM Seminar Hall"],
    ...
    rows: [
      ...
      ["11.00AM to 11.30AM", "----", "High Tea", "----"],
      ["11.30AM to 01.00PM", "Energy Systems Demo at ABB Lab,Department of EEE,RVCE", "Dr. Srivani, HOD, EEE, RVCE", "IEM Seminar Hall"],
      // [
      //     "11.30AM to 01.00PM",
      //     "Demo:  Energy Systems",
      ...
      // ],
      ["01.00PM to 02.00PM", "----", "Lunch", "----"],
      ["02.00PM to 03.15PM", "Smart Sensors amnd its Applications", "Dr K Natarajan , Research Coorinatior, Jain University", "IEM Seminar Hall"],
      ["03.15PM to 03.30PM", "----", "High Tea", "----"],
      ["03.30PM to 04.30PM", "Smart Sensors amnd its Applications", "Dr K Natarajan , Research Coorinatior, Jain University", "IEM Seminar Hall"],
    ],
  },
];

export const Day2: ScheduleData = {
  head: [
    [
      "6 INTERNATIONAL CONFERENCE on Computational Systems & Information Technology Sustainable Solutions [CSITSS-2022] (Tentative schedule, Subject to changes.)",
    ],
...
export const Day3: ScheduleData = {
  head: [
  ...
  rows: [
    ...
    ["10:15-11:00", "Invited Talk- by Dr. Devesh Dwivedi, PhD India Site Leader, Global Foundries", "BT Seminar Hall"],
    ["11:15-11:30", "TEA BREAK", ""],
    ["11:30-1:00", "TRACK 1: Processors: VLSI Design & Embedded Systems: Paper ID:13,24,168,257,92", "BT Seminar Hall"],
    ["", "TRACK 2: Computing Systems and Applications-1 : Paper ID:54,148,167,242,261,120", "MCA Seminar Hall"],
    ["", "TRACK 3: Intelligent Systems-2 : Paper ID:132,138,142,144,146,149", " IEM Seminar Hall"],
    ["1:00-2:00", "LUNCH", "Food Court"],
    ["2:00-2:25", "Plenary Talk/TEA BREAK", ""],
    ["3:00-4:30", "TRACK 1: Intelligent Systems-3:Paper ID:150,129,202,215,226,228", "BT Seminar Hall"],
    ["", "TRACK 2: Communication Systems-2:Paper ID:238,19,254,251", "MCA Seminar Hall"],
    ["", "TRACK 3: Intelligent Systems-4:ID:235,237,240,241,256", "IEM Seminar Hall"],
...
//       '6 INTERNATIONAL CONFERENCE on Computational Systems & Information Technology Sustainable Solutions [CSITSS-2022]',
//     ],
//     ['Conference Day 2/ 22-12-2022'],
//   ],
//   columns: ['Time', 'Event', 'Details', 'Venue'],
//   rows: [
//     [
//       '12.15AM TO 01.00PM',
//       'The Future of Computing',
