...
const variants = {
  ...
  secondary:
    "group bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-700",
};
...
export function ThemedButton({ variant = "primary", className, children, ...props }: ThemedButtonProps) {
  return (
