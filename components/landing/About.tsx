      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
            The 9<sup>th</sup> International Conference on Computational Systems and Information Technology
            for Sustainable Solutions [CSITSS — 2025] brings together leading academicians, scientists,
            researchers, and industry representatives from around the world.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="mx-auto mt-16 max-w-7xl grid gap-8 sm:grid-cols-2 lg:grid-cols-3"
        >
        ...
        <motion.div
          ...
          className="mx-auto mt-16 max-w-5xl rounded-3xl bg-white/50 dark:bg-gray-800/50 p-8 backdrop-blur-xl shadow-xl border border-white/20 dark:border-white/10"
        >
