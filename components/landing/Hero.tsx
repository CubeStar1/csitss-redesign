      ...
      <div className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="relative flex flex-col gap-8 lg:flex-row lg:items-center">
          ...
          >
            ...
            {/* Main Title */}
            <h1 className="mb-6 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl lg:text-6xl dark:text-gray-50">
              WELCOME TO{" "}
              <span className="bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text text-transparent dark:from-blue-400 dark:to-sky-300">CSITSS-2025</span>
            </h1>

            {/* Description */}
            <p className="mb-8 max-w-2xl text-base leading-relaxed text-gray-600 sm:text-lg dark:text-gray-300">
              9<sup>th</sup> International Conference on Computational Systems and Information Technology for Sustainable Solutions, bringing together leading
              academicians, scientists, and researchers from around the world.
            </p>
            ...
            <div className="flex w-full flex-col gap-4 sm:w-auto sm:flex-row">
              ...
              <ThemedButton variant="secondary" size="lg" onClick={() => window.open("CSITSS 2024 Brochure.pdf", "_blank")}>
                <Download className="mr-2 h-4 w-4 transition-transform group-hover:-translate-y-1" />
                Download Brochure
              </ThemedButton>
              <ThemedButton variant="secondary" size="lg" onClick={scrollToTimeline}>
          ...
          <motion.div
            ...
            className="relative  flex-1 items-center justify-center lg:flex lg:justify-end"
          >
            <div className="relative aspect-[4/3] w-full max-w-xl overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-gray-800">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-sky-100 dark:from-blue-900/20 dark:to-sky-900/20"></div>
              <Image src="/rv2.jpg" alt="RVCE Campus" fill className="object-cover object-center opacity-90 dark:opacity-80" priority />
            ...
            <motion.div
              ...
              className="absolute -bottom-6 right-6 rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800"
            >
              <div className="flex items-center gap-3">
                <Image src="/logos/rvce_logo.png" alt="RVCE Logo" width={40} height={40} className="rounded-full" />
                <div>
        ...
        <motion.div
          ...
          className="mt-12 grid grid-cols-1 gap-4 sm:mt-16 sm:grid-cols-2 lg:mt-20 lg:grid-cols-4"
        >
          {stats.map((stat) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative overflow-hidden rounded-2xl bg-gradient-to-br ${stat.gradient} border border-white/10 p-4 shadow-xl backdrop-blur-xl transition-all duration-300
                  ease-out hover:border-white/20 hover:shadow-2xl sm:p-6 dark:bg-opacity-20`}
              >
                <div className="flex h-full flex-col justify-between">
                  <div>
                    ...
                    <p className="mt-4 text-xl font-bold tracking-tight text-gray-900 sm:text-2xl dark:text-gray-50">{stat.value}</p>
                  </div>
