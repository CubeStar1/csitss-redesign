  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-50 transition-opacity duration-300 ease-in-out">
      <div className="relative w-full max-w-sm scale-105 transform rounded-xl bg-blue-50 bg-opacity-90 p-4 shadow-2xl transition-all duration-500 ease-out sm:max-w-md sm:p-6 md:max-w-lg lg:max-w-xl">
        <button onClick={onClose} className="absolute right-3 top-3 text-2xl text-gray-500 hover:text-gray-700 focus:outline-none" aria-label="Close">
          &times;
        </button>
        ...
        <p className="text-center text-sm font-semibold text-gray-800 sm:text-lg">Dear Authors, Reviewers, Attendees, and Session Chairs,</p>

        <p className="mt-4 text-sm leading-relaxed text-gray-700 sm:text-base">
          We are delighted to announce the successful conclusion of the{" "}
          <span className="font-semibold text-blue-600">
            8th IEEE International Conference on Computational Systems and Information Technology for Sustainable Solutions
          </span>{" "}
          on <span className="font-semibold text-purple-600">November 9, 2024</span>.
        </p>
        ...
        <p className="mt-6 text-sm font-semibold text-gray-800 sm:text-lg">Warm regards,</p>

        <p className="mt-2 text-sm leading-relaxed text-gray-700 sm:text-base">
          General Chair
          <br />
          <span className="font-semibold text-blue-600">Dr. B M Sagar</span>, Professor and Head, Dept of Information Science and Engineering, RV College of
          Engineering
          <br />
          <span className="font-semibold text-purple-600">Dr. M Krishna</span>, Professor and Head, Dept of Mechanical Engineering, RV College of Engineering
        </p>
