    ...
    <div className="mt-10">
      ...
      <aside className="bg-gray-100 p-12 sm:p-16 lg:p-24">
        <div className="mx-auto">
          <p className="text-center text-3xl font-bold sm:text-5xl">Call For Papers </p>
          <p className="my-4 text-justify text-2xl font-medium text-gray-700">Conference does not accept/encourage Survey/Review articles.</p>
          <p className="text-justify text-xl font-medium text-gray-500">
            ...
            submit their manuscripts in PDF format not exceeding 6 pages in A4 size through online submission at Microsoft CMT - on or{" "}
            <i>
              before 5<sup>th</sup> August 2023.{" "}
            </i>
            The manuscript should follow the standard IEEE template.The format of the paper could be downloaded in link below{" "}
            <a href="https://www.ieee.org/conferences/publishing/templates.html">
              <b>Manuscript Template Link</b>
            </a>
            .<br />
            All submission for the conference will be handled electronically and submitted papers will be peer reviewed by domain experts. To submit the papers
            use the Microsoft CMT Link mentioned below:
            <br />
